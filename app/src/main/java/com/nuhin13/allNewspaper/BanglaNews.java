        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(MenuItem menuItem) {
                ...
                switch (menuItem.getItemId()){
                    ...
                    case R.id.starred:
                        Intent intent1 = new Intent(BanglaNews.this,EnglishNewPaper.class);
                        startActivity(intent1);

                        return true;

                    case R.id.sent_mail:
                        Intent intent2 = new Intent(BanglaNews.this,OnlineNewPaper.class);
                        startActivity(intent2);

                        return true;
                    case R.id.drafts:
                        Intent intent3 = new Intent(BanglaNews.this,SportsNewsPaper.class);
                        startActivity(intent3);

                        return true;
                    case R.id.allmail:
                        Intent intent4 = new Intent(BanglaNews.this,TechnologyBasedNewspaper.class);
                        startActivity(intent4);

                        return true;
                    case R.id.trash:
                        Intent intent5 = new Intent(BanglaNews.this,Local1st.class);
                    ...
                    case R.id.like:
                        ...
                        String facebookUrl = fb.getFacebookPageURL(BanglaNews.this);
        ...
        listView.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapter, View v,
                ...
                if (position == 0) {
                    ...
                    Intent intent = new Intent(BanglaNews.this, Webcontent.class);
                    startActivity(intent);
                }
                ...
                if (position == 1) {
                     ...
                     //Toast.makeText(getApplicationContext(),"Prothom alo",Toast.LENGTH_SHORT).show();
                     Intent intent = new Intent(BanglaNews.this, ittifaq.class);
                     startActivity(intent);
                ...
                if (position == 2) {
                    ...
                    // Toast.makeText(getApplicationContext(),"Prothom alo",Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(BanglaNews.this, Amardesh.class);
                    startActivity(intent);
                }
                if (position == 3) {

                    Intent intent = new Intent(BanglaNews.this, Samakal.class);
                    startActivity(intent);
                }
                if (position == 4) {

                    // Toast.makeText(getApplicationContext(),"Prothom alo",Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(BanglaNews.this, AmaderSomoy.class);
                    startActivity(intent);
                }
                if (position == 5) {

                    //Toast.makeText(getApplicationContext(),"Prothom alo",Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(BanglaNews.this, Nayadiganta.class);
                    startActivity(intent);
                }
                ...
                if (position == 6) {
                    ...
                    // Toast.makeText(getApplicationContext(),"Prothom alo",Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(BanglaNews.this, KalerKontha.class);
                    startActivity(intent);
                }
                if (position == 7) {

                    // Toast.makeText(getApplicationContext(),"Prothom alo",Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(BanglaNews.this, JJDin.class);
                    startActivity(intent);
                }
                if (position ==8) {

                    Intent intent = new Intent(BanglaNews.this, BDprotidin.class);
                    startActivity(intent);
                }
                if (position == 9) {

                    // Toast.makeText(getApplicationContext(),"Prothom alo",Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(BanglaNews.this, inqilab.class);
                    startActivity(intent);
                }
                if (position == 10) {

                    //Toast.makeText(getApplicationContext(),"Prothom alo",Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(BanglaNews.this, Manabjabin.class);
                    startActivity(intent);
                }
                ...
                if (position == 11) {
                    ...
                    // Toast.makeText(getApplicationContext(),"Prothom alo",Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(BanglaNews.this, Sangram.class);
                    startActivity(intent);
                }
                if (position == 12) {

                    Intent intent = new Intent(BanglaNews.this, VorerKagoj.class);
                    startActivity(intent);

                }
                if (position == 13) {

                    Intent intent = new Intent(BanglaNews.this, jonkontho.class);
                    startActivity(intent);
                }
                if (position == 14) {

                    // Toast.makeText(getApplicationContext(),"Prothom alo",Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(BanglaNews.this, Zugantor.class);
                    startActivity(intent);
                }
                if (position == 15) {

                    //Toast.makeText(getApplicationContext(),"Prothom alo",Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(BanglaNews.this, Sangbad.class);
                    startActivity(intent);
                }
                ...
                if (position == 16) {
                    ...
                    // Toast.makeText(getApplicationContext(),"Prothom alo",Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(BanglaNews.this, SokalerKhobor.class);
                    startActivity(intent);
                }
                if (position == 17) {

                    // Toast.makeText(getApplicationContext(),"Prothom alo",Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(BanglaNews.this, Gonokontho.class);
                    startActivity(intent);
                }
                if (position == 18) {

                    Intent intent = new Intent(BanglaNews.this, BonikBarta.class);
                    startActivity(intent);
                }
                if (position == 19) {

                    // Toast.makeText(getApplicationContext(),"Prothom alo",Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(BanglaNews.this, Dinkal.class);
                    startActivity(intent);
                }
                if (position == 20) {

                    Intent intent = new Intent(BanglaNews.this, Manabkontho.class);
                    startActivity(intent);
                ...
                if (position == 21) {
                    ...
                    Intent intent = new Intent(BanglaNews.this, AlokitoBangladesh.class);
                    startActivity(intent);
                ...
                if (position == 22) {
                    ...
                    Intent intent = new Intent(BanglaNews.this, demo.class);
                    startActivity(intent);
 ...
 /*   public static String FACEBOOK_URL = "https://www.facebook.com/Droid-Builder-1718721518341575/";
  ...
  //int count = -1;
    ...
    private void initAd() {
        ...
        mInterstitialAd = new InterstitialAd(BanglaNews.this);
